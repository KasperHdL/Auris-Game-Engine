...
namespace Action{
    ...
    const SDL_Scancode debug_menu      = SDL_SCANCODE_F1;
    const SDL_Scancode toggleInspector = SDL_SCANCODE_F2;
    const SDL_Scancode toggleHierarchy = SDL_SCANCODE_F3;
    const SDL_Scancode toggleProfiler  = SDL_SCANCODE_F4;
